    ...
    lines.map(
        |result| {
            ...
            let my_choice = match game_result {
                GameResult::Win => match his_choice {
                    Choice::Rock => Choice::Paper,
                    Choice::Paper => Choice::Scissors,
                    Choice::Scissors => Choice::Rock
                },
                GameResult::Loss => match his_choice {
